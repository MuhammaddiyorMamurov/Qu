  ...
  uz: {
    translation: {
      Welcome: "Yangi loyihamizga xush kelibsiz",
       ...
       enter:"Kirish",
       logout:"Muvaffaqiyatli chiqdingiz",
       uncompleted:"Chiqish yakunlanmadi",
       language:"Til o'zgartirildi",
       tosignup:"Ro'yhatdan o'tish"
    }
  },
  ru: {
    translation: {
      ...
      uncompleted:"Вывод не выполнен",
      language:"Язык изменен",
      tosignup:"у вас еще нет учетной записи?"
